...
export function ContactPage() {
  ...
  return (
    <>
      <SEO
        title="Contact Us"
        description="Get in touch with Envionix Labs. Contact us to learn more about our portable environmental testing and toxic element detection solutions."
        url="/contact"
      />
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">envionixlabs@gmail.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+91 7002071035</p>
                      <p className="text-gray-600">+91 8011666517</p>
                    </div>
                  </div>
